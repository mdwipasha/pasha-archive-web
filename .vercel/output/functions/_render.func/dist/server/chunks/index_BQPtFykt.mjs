...
import 'piccolore';
import { m as maybeRenderHead, k as renderTemplate, h as addAttribute, o as renderComponent } from './entrypoint_dDfbRc3X.mjs';
...
const $$SubmitPageCTA = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section class="py-24 px-4"> <div class="max-w-5xl mx-auto border-4 border-black bg-yellow-100 p-8 md:p-12 shadow-[10px_10px_0_0_#000]"> <span class="inline-block border-2 border-black bg-black text-white px-4 py-2 font-black uppercase text-sm">
...
Punya foto, video, atau momen yang ada Pasha di dalamnya? Bantu
            ...
            submission.
</p> <div class="mt-8 flex flex-wrap gap-4 items-center"> <a href="/submit-memory" class="border-4 border-black bg-lime-300 px-6 py-4 font-black uppercase shadow-[6px_6px_0_0_#000] hover:translate-x-1 hover:translate-y-1 hover:shadow-[2px_2px_0_0_#000] transition-all">
Submit Memory →
</a> <span class="font-bold"> Photos • Videos • Stories </span> </div> </div> </section>`;
