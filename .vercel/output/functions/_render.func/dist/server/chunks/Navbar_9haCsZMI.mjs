...
import 'piccolore';
import { p as createRenderInstruction, m as maybeRenderHead, h as addAttribute, k as renderTemplate } from './entrypoint_CSZW9EA2.mjs';
import 'clsx';
...
const $$Navbar = createComponent(($$result, $$props, $$slots) => {
  const navItems = [
    ...
    { name: "Submit Memory", href: "/submit-memory" }
  ];
...
</div> </div> </div> ${renderScript($$result, "D:/CODING/pasha-archive-web/src/components/Navbar.astro?astro&type=script&index=0&lang.ts")}`;
}, "D:/CODING/pasha-archive-web/src/components/Navbar.astro", void 0);
