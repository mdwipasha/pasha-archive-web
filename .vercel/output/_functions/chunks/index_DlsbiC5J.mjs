...
import 'piccolore';
import { q as renderComponent, u as renderTemplate } from './entrypoint_BVRuuQGF.mjs';
...
function ManageModal({
  ...
  async function deletePerson(id, name) {
    if (!window.confirm(`Delete "${name}"? They'll be removed from all memories.`))
      return;
  ...
  async function deleteTag(id, tag) {
    if (!window.confirm(`Delete "#${tag}"? It'll be removed from all memories.`))
      return;
            ...
            /* @__PURE__ */ jsxs("div", { style: { flex: 1, overflowY: "auto", padding: 20 }, children: [
              ...
              tab === "people" && /* @__PURE__ */ jsxs("div", { children: [
                ...
                people.length === 0 ? /* @__PURE__ */ jsx(
                  ...
                  {
                    style: {
                      color: C$2.textSecondary,
                      fontSize: 13,
                      fontStyle: "italic"
                    },
                    children: "No people yet. Add someone above."
                  }
                ) : /* @__PURE__ */ jsx(
                  "div",
                  {
                    style: { display: "flex", flexDirection: "column", gap: 6 },
                    children: people.map((p) => /* @__PURE__ */ jsxs(
                      "div",
                      {
                        style: {
                          display: "flex",
              ...
              tab === "tags" && /* @__PURE__ */ jsxs("div", { children: [
                ...
                tags.length === 0 ? /* @__PURE__ */ jsx(
                  "p",
                  {
                    ...
                    children: "No tags yet. Add one above."
                  }
                ) : /* @__PURE__ */ jsx("div", { style: { display: "flex", flexWrap: "wrap", gap: 8 }, children: tags.map((t) => /* @__PURE__ */ jsxs(
                  "div",
                  {
                    style: {
                      display: "flex",
...
function MemoryForm({ onSaved }) {
  ...
  async function reloadTags() {
    ...
    setTags(fresh);
    setSelectedTags(
      (prev) => prev.filter((id) => fresh.some((t) => t.id === id))
    );
  }
  async function reloadPeople() {
    ...
    setPeople(fresh);
    setSelectedPeople(
      (prev) => prev.filter((id) => fresh.some((p) => p.id === id))
    );
  }
                      ...
                      children: [
                        /* @__PURE__ */ jsx(
                          "span",
                          {
                            ...
                            children: featured && /* @__PURE__ */ jsx(
                              "span",
                              {
                                style: {
                                  color: C$2.yellow,
                  ...
                  children: [
                    /* @__PURE__ */ jsx(
                      "p",
                      {
                        ...
                        children: "Drop image/video here or click to browse"
                      }
                    ),
                    /* @__PURE__ */ jsx(
                      "p",
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsx(
                            Field,
                            {
                              ...
                              ) : /* @__PURE__ */ jsx(Fragment, { children: allTags.length === 0 ? /* @__PURE__ */ jsx(
                                "p",
                                {
                                  style: {
                                    fontFamily: "'Space Grotesk', sans-serif",
                              ...
                              ) : /* @__PURE__ */ jsx("div", { style: { display: "flex", flexWrap: "wrap", gap: 6 }, children: allTags.map((tag2) => /* @__PURE__ */ jsx(
                                Chip,
                                {
                                  label: tag2.tag,
                                  selected: selectedTagIds.includes(tag2.id),
                                  accent: C$1.yellow,
                                  onClick: () => toggleTag(tag2.id)
                                },
                                tag2.id
                              )) }) })
                            }
                          ...
                          /* @__PURE__ */ jsx(
                            "div",
                            {
                              ...
                              children: /* @__PURE__ */ jsx(Field, { label: "Cloudinary ID", children: /* @__PURE__ */ jsx(Input, { value: memory.cloudinary_public_id || "—" }) })
                            }
                          )
                        ]
                      }
                  ...
                  children: [
                    /* @__PURE__ */ jsx(
                      "span",
                      {
                        ...
                        children: busy ? uploading ? "⏳ Uploading to Cloudinary…" : "⏳ Saving…" : `ID ${memory.id} · ${selectedTagIds.length} tag${selectedTagIds.length !== 1 ? "s" : ""} · ${selectedPersonIds.length} person${selectedPersonIds.length !== 1 ? "s" : ""}`
                      }
                    ),
