...
import 'piccolore';
import { o as renderComponent, k as renderTemplate, m as maybeRenderHead } from './entrypoint_CaXNZmEO.mjs';
...
function ImageModal({ memory, onClose }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "overflow-y-auto scrollbar-hide fixed inset-0 z-[9999] flex justify-center items-center p-4 md:p-8 bg-black/50 backdrop-blur-sm" }, /* @__PURE__ */ React.createElement("button", { className: "absolute inset-0 z-0", onClick: onClose }), /* @__PURE__ */ React.createElement("div", { className: "relative z-10 w-full max-w-5xl bg-[#FFFDF8] border-2 border-black shadow-[8px_8px_0_rgba(0,0,0,1)] p-6 md:p-8 rotate-[0.5deg] max-h-[90vh] overflow-y-auto" }, /* @__PURE__ */ React.createElement("div", { className: `tape ${tapeVariant} -rotate-[2deg] top-0 left-10` }), /* @__PURE__ */ React.createElement(
    "button",
    {
      onClick: onClose,
    ...
    /* @__PURE__ */ React.createElement("span", { className: "material-symbols-outlined text-2xl" }, "close")
  ), /* @__PURE__ */ React.createElement("div", { className: "flex flex-col md:flex-row items-start gap-8 mt-4" }, /* @__PURE__ */ React.createElement("div", { className: "w-full md:w-2/3 border-2 border-black p-2 bg-white" }, /* @__PURE__ */ React.createElement(
    "img",
    {
      alt: memory.title,
  ...
  )), /* @__PURE__ */ React.createElement("div", { className: "w-full md:w-1/3 flex flex-col justify-between" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-3 mb-2" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-2 mb-3" }, (memory.tags || []).map((tag) => /* @__PURE__ */ React.createElement(
    "span",
    {
      key: tag,
      className: `
    ...
    "#",
    tag
  )))), /* @__PURE__ */ React.createElement("h2", { className: "text-1xl md:text-2xl font-black text-black mb-1 leading-tight" }, memory.title), /* @__PURE__ */ React.createElement("p", { className: "text-xs capitalize tracking-wider font-bold text-[#6B7280] mb-4 border-b-2 border-black pb-2" }, memory.date || memory.year, " — ", memory.location || "Unknown"), /* @__PURE__ */ React.createElement("p", { className: "text-xs leading-relaxed text-[#444748] mb-4" }, memory.description), /* @__PURE__ */ React.createElement("div", { className: "flex flex-col gap-4 mt-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex gap-4" }, /* @__PURE__ */ React.createElement(
    "button",
    {
      onClick: handleLike,
      disabled: liked,
    ...
    /* @__PURE__ */ React.createElement("span", { className: "material-symbols-outlined" }, "chat_bubble"),
    /* @__PURE__ */ React.createElement("span", null, commentsCount)
  )))), /* @__PURE__ */ React.createElement("div", { className: "mt-6 pt-3 border-t-2 border-black border-dashed" }, /* @__PURE__ */ React.createElement("p", { className: "text-[10px] uppercase tracking-[0.05em] font-semibold text-[#6B7280] mb-2" }, "People in Frame"), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-1.5" }, /* @__PURE__ */ React.createElement(
    "a",
    {
    ...
    /* @__PURE__ */ React.createElement("span", { className: "material-symbols-outlined text-[12px]" }, "person"),
    /* @__PURE__ */ React.createElement("p", { className: "underline" }, "Me")
  ), (memory.people || []).map(
    (people, index) => people.social_media ? /* @__PURE__ */ React.createElement(
      "a",
      {
        key: index,
      ...
      /* @__PURE__ */ React.createElement("span", { className: "material-symbols-outlined text-[12px]" }, "person"),
      /* @__PURE__ */ React.createElement("p", { className: "underline" }, people.name)
    ) : (
...
function VideoModal({ memory, onClose }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "fixed inset-0 z-[9999] flex justify-center items-center p-4 bg-black/60 backdrop-blur-sm" }, /* @__PURE__ */ React.createElement("button", { className: "absolute inset-0 z-0", onClick: onClose }), /* @__PURE__ */ React.createElement("div", { className: "relative z-10 bg-[#FFFDF8] border-2 border-black shadow-[8px_8px_0_rgba(0,0,0,1)] p-3 rotate-[0.5deg]" }, /* @__PURE__ */ React.createElement("div", { className: `tape ${tapeVariant} -rotate-[2deg] top-0 left-10` }), /* @__PURE__ */ React.createElement("div", { className: "absolute top-3 left-3 z-30" }, /* @__PURE__ */ React.createElement(
    "button",
    {
      onClick: () => setMuted(!muted),
      className: "\r\n                absolute\r\n                w-10\r\n                h-10\r\n                top-3\r\n                left-3\r\n                bg-[#FFFDF8]\r\n                border-2\r\n                border-black\r\n                shadow-[3px_3px_0_rgba(0,0,0,1)]\r\n                flex\r\n                items-center\r\n                justify-center\r\n            "
    },
    /* @__PURE__ */ React.createElement("span", { className: "material-symbols-outlined" }, muted ? "volume_off" : "volume_up")
  )), /* @__PURE__ */ React.createElement(
    "button",
    {
      onClick: onClose,
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("span", { className: "material-symbols-outlined text-6xl text-black" }, "play_arrow")
    )
  ), /* @__PURE__ */ React.createElement("div", { className: "relative w-[360px] sm:w-[380px] h-[75vh] sm:h-[90vh] border-2 border-black overflow-hidden bg-black" }, /* @__PURE__ */ React.createElement(
    "video",
    {
      src: memory.src,
      ref: videoRef,
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("span", { className: "text-white text-xs font-black" }, likes)
    ),
    /* @__PURE__ */ React.createElement(
      "a",
      {
      ...
      /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement("span", { className: "material-symbols-outlined text-[8px]" }, "chat_bubble")
      ),
      /* @__PURE__ */ React.createElement("span", { className: "text-white text-xs font-black" }, commentsCount)
    )
  ), /* @__PURE__ */ React.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ React.createElement("h2", { className: "font-black text-lg leading-tight mb-1" }, "mdpashaaa"),
    /* @__PURE__ */ React.createElement(
      "p",
      {
    ...
    expanded && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "mt-3" }, /* @__PURE__ */ React.createElement("p", { className: "text-[10px] uppercase font-bold text-gray-400 mb-2" }, "People in Frame"), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-2" }, /* @__PURE__ */ React.createElement(
      "a",
      {
      ...
      (person, index) => person.social_media ? /* @__PURE__ */ React.createElement(
        "a",
        {
          key: index,
      ...
      hiddenCount,
      " More"
    ))), showPeopleModal && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(
      "button",
      {
      ...
      /* @__PURE__ */ React.createElement("div", { className: "flex justify-between items-center mb-4" }, /* @__PURE__ */ React.createElement("h3", { className: "font-black" }, "People in Frame (", (memory.people || []).length + 1, ")"), /* @__PURE__ */ React.createElement(
        "button",
        {
          onClick: () => setShowPeopleModal(false),
          className: "\r\n                            w-8\r\n                            h-8\r\n                            border-2\r\n                            text-black\r\n                            border-black\r\n                            bg-white\r\n                            flex\r\n                            items-center\r\n                            justify-center\r\n                            cursor-pointer\r\n                        "
      ...
      /* @__PURE__ */ React.createElement("div", { className: "flex flex-col gap-2 max-h-[50vh] overflow-y-auto" }, /* @__PURE__ */ React.createElement(
        "a",
        {
          href: "https://instagram.com/mdpashaaa",
          target: "_blank",
        ...
        /* @__PURE__ */ React.createElement("span", { className: "flex items-center gap-2" }, /* @__PURE__ */ React.createElement("span", { className: "material-symbols-outlined" }, "person"), "Me"),
        /* @__PURE__ */ React.createElement("span", { className: "material-symbols-outlined" }, "open_in_new")
      ), (memory.people || []).map(
        (person, index) => person.social_media ? /* @__PURE__ */ React.createElement(
          "a",
          {
          ...
          /* @__PURE__ */ React.createElement("span", { className: "flex items-center gap-2" }, /* @__PURE__ */ React.createElement("span", { className: "material-symbols-outlined" }, "person"), person.name),
          /* @__PURE__ */ React.createElement("span", { className: "material-symbols-outlined" }, "open_in_new")
        ) : /* @__PURE__ */ React.createElement(
          "div",
          {
          ...
          /* @__PURE__ */ React.createElement("span", { className: "material-symbols-outlined" }, "person"),
          person.name
        )
      ))
    )), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-gray-400 mt-2" }, memory.date || memory.year, " — ", memory.location), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-2 mt-3" }, memory.tags?.map((tag) => /* @__PURE__ */ React.createElement(
      "span",
      {
        key: tag,
        className: `
...
function GalleryModal(props) {
  ...
  if (memory.type === "Video") {
    return /* @__PURE__ */ React.createElement(VideoModal, { ...props });
  }
  return /* @__PURE__ */ React.createElement(ImageModal, { ...props });
}
...
function GalleryCard({ memory, index = 0 }) {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { className: `tape ${tapeVariants[idx]}` }),
    /* @__PURE__ */ React.createElement(
      "div",
      {
      ...
      /* @__PURE__ */ React.createElement(
        ...
        memory.type === "Video" ? /* @__PURE__ */ React.createElement(
          "img",
          {
      ...
      /* @__PURE__ */ React.createElement("div", { className: "flex justify-between items-start gap-3" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { className: "font-black text-xl mb-1" }, memory.title), /* @__PURE__ */ React.createElement("p", { className: "text-[14px] uppercase tracking-[0.05em] font-semibold text-[#6B7280]" }, memory.year)), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-1 justify-end max-w-[50%]" }, (memory.tags || []).slice(0, 3).map((tag) => /* @__PURE__ */ React.createElement(
        "span",
        {
          key: tag,
          className: `
        ...
        tag
      )), (memory.tags || []).length > 3 && /* @__PURE__ */ React.createElement(
        "span",
        {
          className: "\r\n                  inline-block\r\n                  px-2\r\n                  py-1\r\n                  border\r\n                  border-black\r\n                  bg-[#E5E7EB]\r\n                  text-[10px]\r\n                  font-semibold\r\n                  uppercase\r\n                  tracking-[0.05em]\r\n                "
        },
    ...
    /* @__PURE__ */ React.createElement(GalleryModal, { memory, onClose: () => setOpen(false) }),
    document.body
  ));
}
...
function FilterGroup({ label, options, selected, onToggle, accent }) {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { className: "text-[10px] font-black uppercase tracking-[0.25em] mb-2.5 opacity-40" }, label), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-2" }, options.map((opt) => {
...
function ActiveChip({ label, onRemove }) {
  return /* @__PURE__ */ React.createElement("span", { className: "flex items-center gap-1 border-2 border-black bg-[#FFFDF8] px-2.5 py-1 text-[11px] font-bold uppercase tracking-wide shadow-[2px_2px_0_rgb(0,0,0)]" }, label, /* @__PURE__ */ React.createElement(
    "button",
    {
      onClick: onRemove,
...
function GallerySection({ memories }) {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "flex gap-3 mb-4" }, /* @__PURE__ */ React.createElement("div", { className: "relative flex-1" }, /* @__PURE__ */ React.createElement("span", { className: "absolute left-3.5 top-1/2 -translate-y-1/2 text-base opacity-30 pointer-events-none select-none" }, "🔍"), /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "text",
      value: searchQuery,
    ...
    totalActiveFilters > 0 && /* @__PURE__ */ React.createElement("span", { className: "border border-current text-[10px] font-black px-1.5 py-0.5 leading-none bg-[#FFD700] text-black border-black" }, totalActiveFilters)
  )), showFilters && /* @__PURE__ */ React.createElement("div", { className: "border-2 border-black bg-[#FFFDF8] p-5 mb-5 shadow-[4px_4px_0_rgb(0,0,0)] flex flex-col gap-5" }, /* @__PURE__ */ React.createElement(
    FilterGroup,
    {
      label: "Tags",
  ...
  ), totalActiveFilters > 0 && /* @__PURE__ */ React.createElement("div", { className: "pt-3 border-t-2 border-black border-dashed" }, /* @__PURE__ */ React.createElement(
    "button",
    {
      onClick: clearAll,
    ...
    "Clear all filters"
  ))), hasActiveFilters && /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap items-center gap-2 mb-5" }, searchQuery.trim() && /* @__PURE__ */ React.createElement(
    ActiveChip,
    {
      label: `"${searchQuery}"`,
      onRemove: () => setSearchQuery("")
    }
  ), activeChips.map(({ label, onRemove }) => /* @__PURE__ */ React.createElement(ActiveChip, { key: label, label, onRemove })), hasActiveFilters && /* @__PURE__ */ React.createElement(
    "button",
    {
      onClick: clearAll,
    ...
    "Clear all"
  )), /* @__PURE__ */ React.createElement("p", { className: "text-[11px] font-bold uppercase tracking-[0.2em] opacity-35 mb-10" }, filteredMemories.length === memories.length ? `${memories.length} memories` : `${filteredMemories.length} of ${memories.length} memories`), visibleMemories.length > 0 ? /* @__PURE__ */ React.createElement("div", { className: "masonry-grid w-full" }, visibleMemories.map((memory, index) => /* @__PURE__ */ React.createElement(
    "div",
    {
      key: memory.id,
      className: `masonry-item relative ${ROTATIONS[index % 6]}`
    },
    /* @__PURE__ */ React.createElement(GalleryCard, { memory, index, "client:load": true })
  ))) : /* @__PURE__ */ React.createElement("div", { className: "border-2 border-black bg-[#FFFDF8] py-20 text-center shadow-[4px_4px_0_rgb(0,0,0)]" }, /* @__PURE__ */ React.createElement("div", { className: "text-5xl mb-4" }, "🗂️"), /* @__PURE__ */ React.createElement("p", { className: "font-black uppercase tracking-[0.2em] text-base mb-1" }, "No memories found"), /* @__PURE__ */ React.createElement("p", { className: "text-sm opacity-40 mb-6" }, "Try adjusting your filters or search"), /* @__PURE__ */ React.createElement(
    "button",
    {
      onClick: clearAll,
    ...
    "Clear all filters"
  )), visibleCount < filteredMemories.length && /* @__PURE__ */ React.createElement("div", { className: "flex justify-center mt-16" }, /* @__PURE__ */ React.createElement(
    "button",
    {
